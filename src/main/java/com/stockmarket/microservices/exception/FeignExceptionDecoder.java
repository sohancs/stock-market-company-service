...
public class FeignExceptionDecoder implements ErrorDecoder {
	...
	public Exception decode(String methodKey, Response response) {
		...
		LOGGER.error("inside ManageCompany Service FeignExceptionDecoder response => {}, {}", errorDetails, methodKey);
		...
		if (!StringUtils.isEmpty(errorDetails.getSourceClass())) {
			...
			case "CompanyAlreadyExistsException":
				return new CompanyAlreadyExistsException(errorDetails.getErrorMesssage());
			default:
